...
export const metadata: Metadata = {
  title: "Pricing",
  description:
    "Three tiers. One honest way in. Every engagement starts with a $449 Assessment.",
};
...
export default function PricingPage() {
  return (
    <main className="pb-24">
      ...
      <section className="mx-auto max-w-[1280px] px-8 pt-12 pb-16 lg:pt-20 lg:pb-20">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-end lg:gap-16">
          ...
          <div className="flex flex-col">
            <p className="mb-8 max-w-[560px] text-base leading-[1.5] text-ink-secondary lg:text-lg">
              Every engagement starts with a $449 Assessment. After that, we
              either build the thing — a website, a go-to-market motion, a
              custom app — or we don&apos;t, and the $449 applies as a credit.
              No hourly billing, no surprises mid-build.
            </p>
      ...
      <section className="mx-auto mt-24 w-full max-w-[1280px] px-8">
        ...
        <p className="mt-8 max-w-[720px] text-sm leading-[1.625] text-ink-tertiary italic">
          All three tiers funnel to the Assessment as the booking action. The
          Assessment is the only thing on the site you can buy without a
          conversation first.
        </p>
      </section>
